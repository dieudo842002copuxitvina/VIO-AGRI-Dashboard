...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMessage(err instanceof Error ? err.message : 'Email hoáº·c máº­t kháº©u khÃ´ng chÃ­nh xÃ¡c')
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 border border-green-100">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm mt-1">Ná»n táº£ng quáº£n lÃ½ nÃ´ng sáº£n</p>
          </div>
          ...
          {errorMessage && (
            <div
              className={`mb-6 flex items-start gap-3 p-4 rounded-lg border ${
                errorMessage.includes('thÃ nh cÃ´ng')
